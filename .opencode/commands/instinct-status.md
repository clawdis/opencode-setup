...
```bash
python3 .opencode/skills/continuous-learning-v2/scripts/instinct-cli.py status
```
...
2. Read project instincts from `.opencode/instincts/`
3. Read global instincts from `~/.opencode/homunculus/instincts/`
