...
- Project: `~/.agents/homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `~/.agents/homunculus/observations.jsonl`
...
- Project: `~/.agents/homunculus/projects/<project-hash>/instincts/personal/`
- Global: `~/.agents/homunculus/instincts/personal/` (for universal patterns)
