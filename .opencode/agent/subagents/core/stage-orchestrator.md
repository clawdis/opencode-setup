...
2. Initialize stage tracking:
   ```bash
   npx ts-node .opencode/skills/task-management/scripts/stage-cli.ts init {feature}
   ```
...
1. **Validate Prerequisites**
   ```bash
   npx ts-node .opencode/skills/task-management/scripts/stage-cli.ts validate {feature} {stage}
   ```
...
3. **Validate Stage Completion**
   ```bash
   npx ts-node .opencode/skills/task-management/scripts/stage-cli.ts complete {feature} {stage}
   ```
...
3. **Execute Rollback (if needed)**
   ```bash
   npx ts-node .opencode/skills/task-management/scripts/stage-cli.ts rollback {feature} {stage}
   ```
...
1. **Check Stage Status**
   ```bash
   npx ts-node .opencode/skills/task-management/scripts/stage-cli.ts status {feature}
   ```
...
2. **Execute Abort**
   ```bash
   npx ts-node .opencode/skills/task-management/scripts/stage-cli.ts abort {feature}
   ```
