  ...
  <execute_directly_when>
   ...
   <specialized_routing>
     <route to="TaskManager" when="complex_feature_breakdown">
       ...
       <source_plan_handoff>
         If a source plan exists for this feature (any of these):
         - A Plannotator plan was just approved in this session (/webReview → approved)
         - User explicitly provided a plan file path
         Then include `source_plan_path: {full-path}` in the delegation prompt below.
